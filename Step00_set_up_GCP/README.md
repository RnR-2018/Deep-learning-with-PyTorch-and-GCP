...
- You can choose to **add GPU** to the VM by expanding the "CPU platform and GPU" option under the "Machine configuration" panel. We choose to add 2 NVIDIA Tesla T4 GPUs.
