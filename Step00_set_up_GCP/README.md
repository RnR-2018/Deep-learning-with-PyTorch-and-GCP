...
- *LET US VERIFY THIS! You can choose to **add GPU** to the VM by expanding the "CPU platform and GPU" option under the "Machine configuration" panel. We chose to add 1 NVIDIA Tesla T4 GPU.*
